		                    	...
		                    	<div class="col-4">
				                    <div class="icon-field">
				                        <select class="form-control" name="day">
				                        	<option selected value="<?php echo e(date('d')); ?>">Day</option>
				                        	<?php for($d = 1; $d <= 31; $d++): ?>
		                    	...
		                    	<div class="col-4">
				                    <div class="icon-field">
				                        <select class="form-control" name="month">
				                        	<option selected value="<?php echo e(date('m')); ?>">Month</option>
				                        	<?php for($m = 1; $m <= 12; $m++): ?>
		                    	...
		                    	<div class="col-4">
				                    <div class="icon-field">
				                        <select class="form-control" name="year">
				                        	<option selected value="<?php echo e(date('Y')); ?>">Year</option>
