<aside class="sidebar">
    ...
    <div>
        <a href="<?php echo e(url('dashboard')); ?>" class="sidebar-logo">
            <img src="<?php echo e(assets('assets/images/l-light.png')); ?>" alt="site logo" class="light-logo" style="width:120px;margin:auto;">
            <img src="<?php echo e(assets('assets/images/l-dark.png')); ?>" alt="site logo" class="dark-logo" style="width:120px;margin:auto;">
